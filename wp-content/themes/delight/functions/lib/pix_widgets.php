...
class pixThumbGallery extends WP_Widget
{
	...
	?>
        <div class="imgHentry<?php if($i % 3 === 0) { ?> marginZero<?php } ?>">
            	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/scripts/timthumb.php?src=<?php echo $thumb_src[0]; ?>&amp;h=64&amp;w=64" alt="<?php echo $image['title']; ?>">
...
foreach( $images as $image ) {
	...
	?>
        <div class="imgHentry<?php if($i % 3 === 0) { ?> marginZero<?php } ?>">
            	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/scripts/timthumb.php?src=<?php echo $phpFlickrObj->buildPhotoURL($image, "thumbnail"); ?>&amp;h=64&amp;w=64" alt="<?php echo $image['title']; ?>">
            <div class="linkIcon" style="width:64px; height:64px;">
