...
function pixSlideshow( $atts, $content = null ) {
	...
	$out = '<div class="pix_cycle" data-time="'.$time.'" style="width:'.$size[0].'px; height:'.$size[1].'px">';
	$out .= do_shortcode($content);
	$out .= '</div><!-- .pix_cycle -->
        <div class="pix_slider_nav"></div><!-- .pix_slider_nav -->';
...
function pixMovieFrame( $atts, $content = null ) {
	...
	if($poster!=''){
		...
		<script type="text/javascript">
	        flowplayer("'.$id.'", {src:"'.get_bloginfo( 'stylesheet_directory' ).'/scripts/flowplayer-3.2.7.swf", wmode:"opaque"},  {
            clip: {
                autoPlay: '.$autoPlay.', 
                scaling: "orig",
                autoBuffering: true
            ...
            plugins: {
                viral: {
                    url: "'.get_bloginfo( 'stylesheet_directory' ).'/scripts/flowplayer.viralvideos-3.2.5.swf"
                }
            }
        });
		</script>';
...
function pixUItab( $atts, $content = null ) {
	...
	$out = '<li><a href="#'.sanitize_title($title).'">'.$title.'</a></li>';
...
function pixUItabContent( $atts, $content = null ) {
	...
	$out .= '<div id="'.sanitize_title($title).'">'.do_shortcode($content).'</div>';
...
function pixColumns( $atts, $content = null ) {
	...
	$out = '<div class="pix_columns">'.general_cleaner(clean_shortcode($content)).'</div>';
...
function colTwo( $atts, $content = null ) {
	...
	$out = '<div class="col_two pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colThree( $atts, $content = null ) {
	...
	$out = '<div class="col_three pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colTwoThree( $atts, $content = null ) {
	...
	$out = '<div class="col_two_three pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colFour( $atts, $content = null ) {
	...
	$out = '<div class="col_four pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colTwoFour( $atts, $content = null ) {
	...
	$out = '<div class="col_two_four pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colThreeFour( $atts, $content = null ) {
	...
	$out = '<div class="col_three_four pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colFive( $atts, $content = null ) {
	...
	$out = '<div class="col_five pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colTwoFive( $atts, $content = null ) {
	...
	$out = '<div class="col_two_five pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function colThreeFive( $atts, $content = null ) {
	...
	$out = '<div class="col_three_five pix_column'.$margin.'">'.clean_shortcode($content).'</div>';
...
function pixBox( $atts, $content = null ) {
	...
	$out = '<div class="pix_box '.$icon.'" style="background-color:'.$bg.'; color:'.$color.'; border:'.$border_size.'px '.$border_color.' '.$border_style.'">'.clean_shortcode($content).'</div>';
...
function pixPriceTable( $atts, $content = null  ) {
   ...
   return '<div class="price_table td_'.$columns.'" id="'.$id.'">'.general_cleaner($content).'</div>';
}
...
function pixPriceTitle( $atts, $content = null  ) {
   ...
   return '<div class="price_title">'.general_cleaner($content).'</div><!-- .price_title -->';
