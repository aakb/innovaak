...
<?php if ($current_user->display_name == 'pix_test' || $current_user->display_name == 'manu_test') { ?><p class="howto" style="padding:5px 10px">In this preview you can see only the <strong>Delight Admin panel</strong>, nothing else. And some features of the admin panel itself are unavailable, such as the media uploading... <strong>but try to change something and go <a href="http://www.pixedelic.com/themes/delight/" target="_blank">back to the site</a> to see the result!</strong></p><?php } ?>
	<div id="pix_credits">
    	<?php if(get_pix_option('pix_show_tweets')=="show") { ?><div id="twitter_update_list"></div><?php } ?>
...
<?php if(get_pix_option('pix_show_tweets')=="show") { ?><script type="text/javascript" src="http://twitter.com/javascripts/blogger.js"></script>
<script type="text/javascript" src="http://twitter.com/statuses/user_timeline/pixedelic.json?callback=twitterCallback2&count=3"></script><?php } ?>
        ...
        <div id="pix_body">
            ...
            <div id="general-tab">
                ...
                <div id="header-tab">
                    ...
                    <div class="block_separator">
                        <label for="pix_social_bar">Social and search bar<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/socialbar.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                    ...
                    <div class="block_separator">
                        <label for="pix_rss_icon">Content of RSS feeds</label>
                        <input type="hidden" value="0" name="pix_rss_icon">
                        <input type="checkbox" value="show" name="pix_rss_icon"<?php if(get_pix_option('pix_rss_icon')=="show") { ?> checked="checked"<?php } ?>>
                        <div class="clear"></div>
                        <label for="pix_rss_url" class="innerlabel">RSS URL</label><input name="pix_rss_url" id="pix_rss_url" type="text" value="<?php echo stripslashes(get_pix_option( 'pix_rss_url' )); ?>" style="width:50%" />
                ...
                <div id="footer-tab">
                    <div class="block_separator">
                        <label for="pix_footer_sitetitle">Site title on the footer<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/footertitle.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                    ...
                    <div class="block_separator">
                        <label for="pix_footer_credits">Credits on the footer<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/footercredits.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                    ...
                    <div class="block_separator">
                        <label for="pix_photocredits_show">Show credits of photographs / videos<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/photocredits.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                    ...
                    <div class="block_separator">
                        <label for="pix_photocommands_show">Show commands for slideshow / videos<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/commands.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                    ...
                    <div class="block_separator">
                        <label for="pix_footerthumbnail_show">Show thumbnails for slideshow<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/slidethumb.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                ...
                <div id="scripts-tab">
                	...
                	<div class="block_separator">
                    	<label for="pix_google_prevent">Block the download from Google's servers<small>If you switch off you can't use Google fonts: probably your connection will be faster but you need to use web safe fonts<br>N.B.: after saving refresh the page.</small></label>
             ...
             <div id="typo-tab">
                ...
                <form method="post">
             	...
             	<div id="navigation-typo-tab">
                    <div class="block_separator">
                        <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/firstlevellink.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
                    ...
                    <div class="block_separator">
                        <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/secondlevellink.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
                    ...
                    <div class="block_separator">
                        <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/thirdlevellink.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
             	...
             	<div id="footer-typo-tab">
                    <div class="block_separator">
                    <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/footertitle.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
           ...
           <div id="colors-tab">
                ...
                <div id="bodybg-tab">
                    <div class="block_separator pix_color">
                        ...
                        <img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/images/color_picker_icon.gif" width="20" height="20" style="cursor:pointer; display:block; float:left; margin:6px 0 0 1px" class="a_palette" />
                    ...
                    <div class="block_separator toggle pix_body_background" id="pix_body_background" data-type="single_image">
                    	<label for="pix_body_background_single_image">
                        	Upload your image
                            <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/uploadimage.php?TB_iframe=true&width=600&height=550" class="info thickbox">how to</a>)</small>
                        </label>
                ...
                <div id="widebg-tab">
                    ...
                    <div class="block_separator toggle pix_general_background" id="pix_general_background" data-type="video">
                    	<label for="pix_wide_video_general">
                        	Upload your video
                            <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/uploadvideo.php?TB_iframe=true&width=600&height=550" class="info thickbox">how to</a>)</small>
                        </label>
                    ...
                    <div class="block_separator toggle pix_general_background" id="pix_general_background" data-type="googlemap">
                    	<label for="pix_wide_googlemap_general">
                        	Coordinates <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/googlemap-coords.php" class="pix_tips_ajax topLeft" data-width="520" data-height="467">how can I get them?</a>)</small>
                        </label>
                ...
                <div id="general-colors-tab">
                    <div class="block_separator pix_color">
                        <label for="pix_content_background">Content area background color<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/contentbg.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small></label>
                ...
                <div id="navigation-colors-tab">
                	<div class="block_separator">
                    	<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/firstnavigation.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
                ...
                <div id="2navigation-colors-tab">
                	<div class="block_separator">
                    	<small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/secondnavigation.php?TB_iframe=true&width=600&height=550" class="info thickbox">what's that?</a>)</small>
                        <div class="pix_color clear">
                ...
                <div id="background-front-tab">
                    ...
                    <div class="block_separator toggle pix_home_background" id="pix_home_background" data-type="googlemap">
                    	<label for="pix_wide_googlemap_home">
                        	Coordinates <small>(<a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/googlemap-coords.php" class="pix_tips_ajax topLeft"  data-rel="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/googlemap-coords.php" data-width="520">how can I get them?</a>)</small>
                        </label>
    ...
    ?>
                ...
                <div id="associate-sidebars-tab">
                    <div class="block_separator">
                        <label>To associate a sidebar to the frontpage, click &quot;Frontpage -&gt; Sidebar&quot;</label>
                    </div><!-- .block_separator -->
...
<div class="captchaCont">[pix_captcha_img] [pix_captcha_input]</div><?php } else { echo stripslashes($pix_array_your_field[$i2][8]); } ?></textarea>
            ...
            <div id="blog-tab">
				...
				<?php $categories = get_categories();
					foreach ($categories as $category) { if (in_array($category->cat_ID, $category_ids)) {  ?>
            ...
            <div id="translation-tab">
                ...
                <div id="download-poedit-tab">
                	<div class="block_separator">
                        ...
                        <p>
                        	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/images/poedit-screenshot.jpg">
                        </p>
                    </div><!-- .block_separator -->
                ...
                <div id="open-po-tab">
                	<div class="block_separator">
                        ...
                        <p>
                        	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/images/open-poedit.jpg">
                        </p>
                    </div><!-- .block_separator -->
                </div><!-- #open-po-tab -->
                ...
                <div id="translate-strings">
                	<div class="block_separator">
                        ...
                        <p>
                        	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/images/translate-poedit.jpg">
                        </p>
                    </div><!-- .block_separator -->
                ...
                <div id="save-po">
                	<div class="block_separator">
                        ...
                        <p>
                        	<img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/functions/documentation/images/define_wplang.jpg">
                        </p>
                        <p>
