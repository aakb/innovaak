...
if(get_pix_option('pix_sidebar_frontpage_layout')=='nosidebar' && get_pix_option('pix_front_page_layout') == 'wide'){ $width = 'seveneighty'; $size_th = 'wideCol'; $sizes = '&amp;h=399&amp;w=708'; $new_size= ' style="width:708px; height:399px;"'; } else { $size_th = 'narrowCol'; $sizes = '&amp;h=240&amp;w=427'; $new_size= ' style="width:427px; height:240px;"'; }
?>
    ...
    if($meta_title['payoff']!='') {
        ...
        $the_title = get_the_title();
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class('hentry'); ?>>
				...
				<?php if (get_pix_option('pix_frontpage_length_excerpt')=='excerpt') { custom_the_excerpt(get_pix_option('pix_frontpage_length_excerpt'), __('Read more','delight')); } else { the_content(__('Read more','delight')); } ?>
                <div class="clear"></div>
            </div>
		<?php endwhile; ?>
...
if(get_pix_option('pix_sidebar_frontpage_layout')=='nosidebar' && get_pix_option('pix_front_page_layout') == 'wide'){ $width = 'seveneighty'; $size_th = 'wideCol'; $size_page = 710; }
				...
				?>
                	<div class="imgHentry" style="width:<?php echo $imgwidth+2; ?>px; height:<?php echo $imgheight+2; ?>px; margin-top:0">
                        ...
                        <div class="linkIcon" style="width:<?php echo $imgwidth; ?>px; height:<?php echo $imgheight; ?>px;"><?php $the_id = get_the_ID(); ?>
                            ...
                            <?php if(get_pix_option('pix_frontpage_galleries_gotopage')=='show') { ?><a href="<?php the_permalink(); ?>" class="goto-icon" <?php echo tooltip_info(__('Go to the attachment page','delight')); ?> style="width:<?php echo $imgwidth2; ?>px; height:<?php echo $imgheight; ?>px;">&nbsp;</a><?php } ?>
                        </div>
                    </div><!-- .imgHentry -->
				<?php } ?>
                <div class="clear"></div>
