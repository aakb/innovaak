...
function is_blog_installed() {
	...
	foreach ( $wp_tables as $table ) {
		...
		// Die with a DB error.
		$wpdb->error = sprintf( /*WP_I18N_NO_TABLES*/'En eller flere databasetabeller er ikke tilgængelige. Databasen har måske brug for at blive <a href="%s">repareret</a>.'/*/WP_I18N_NO_TABLES*/, 'maint/repair.php?referrer=is_blog_installed' );
		dead_db();
	}
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><?php echo /*WP_I18N_DB_ERROR*/'Databasefejl'/*/WP_I18N_DB_ERROR*/; ?></title>

</head>
<body>
	<h1><?php echo /*WP_I18N_DB_CONNECTION_ERROR*/'Fejl ved etablering af databaseforbindelse'/*/WP_I18N_DB_CONNECTION_ERROR*/; ?></h1>
</body>
</html>
<?php
	die();
